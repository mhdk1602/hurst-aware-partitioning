...
I write this paper alone. The companion infrastructure on Hurst estimation originates from earlier work on volatility--volume fractal coupling~\cite{malempatihari2026fractal}.
...
Code: \url{https://github.com/mhdk1602/hurst-aware-partitioning}, MIT license. Tagged \texttt{v0.1.0-prereg} (registered protocol) and \texttt{v0.2.0} (pilot). Pre-registration archived on Zenodo (concept DOI \href{https://doi.org/10.5281/zenodo.20188013}{10.5281/zenodo.20188013}, version DOI \href{https://doi.org/10.5281/zenodo.20188014}{10.5281/zenodo.20188014}). All seeds pinned at \texttt{20260514}. The query library hashes to a SHA-256 in \texttt{experiments/query-library-v1.json.sha256}; reproductions can verify they have the same workload. Test coverage is on the scaffolding only; no D1 or D2 analyses have been performed prior to this writing.
...
\href{https://doi.org/10.5281/zenodo.19611543}{doi:10.5281/zenodo.19611543}.
